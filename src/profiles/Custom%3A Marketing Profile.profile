...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>AZ_Approls_POC</application>
    ...
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.Description__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.ISAS_Server_Type__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>true</editable>
        <field>IT_Workflows__c.Location__c</field>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.Other_Accident_Description__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.Police_Report_Number__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.Police_Station__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.Report_Date__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>true</editable>
        <field>IT_Workflows__c.Secure_Id_Type__c</field>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>true</editable>
        <field>IT_Workflows__c.Type__c</field>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>IT_Workflows__c.User_Details__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
    ...
    <fieldLevelSecurities>
        <editable>true</editable>
        <field>User.Office_Location_Name__c</field>
    </fieldLevelSecurities>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>IT_Workflows__c-ISAS Server IT Approval</layout>
        <recordType>IT_Workflows__c.ISAS_Server_IT_Approval</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>IT_Workflows__c-ISAS Server User Request</layout>
        <recordType>IT_Workflows__c.ISAS_Server_User_Request</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>IT_Workflows__c-IT Workflows Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>IT_Workflows__c-Mobile Device Accident Form</layout>
        <recordType>IT_Workflows__c.Mobile_Device_Accident_Form</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>IT_Workflows__c-SecureID IT Approval</layout>
        <recordType>IT_Workflows__c.SecureId_IT_Approval</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>IT_Workflows__c-SecureID User Request</layout>
        <recordType>IT_Workflows__c.SecureId_User_Request</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>WorkflowInstructions</apexPage>
